...
@interface NACaoGaoViewController ()

@end

@implementation NACaoGaoViewController
...
- (void)viewDidLoad {
    ...
    self.tabBarItem.title=@"草稿";//注意如果这个标题不设置默认在页签上显示视图控制器标题
    self.tabBarItem.image=[UIImage imageNamed:@"ic_menu_mark.png"];//默认图片
    self.tabBarItem.selectedImage=[UIImage imageNamed:@"ic_menu_mark.png"];//选中图片
