...
#error MToastUtil requires ARC
#endif

#if __IPHONE_OS_VERSION_MIN_REQUIRED < 80000
#error MToastUtil requires deployment target iOS 8.0 or higher
#endif
...
@interface MToastUtil()

@property (nonatomic) NSInteger duration;
@property (nonatomic) BOOL roundedCorners;
@property (nonatomic) MToastUtilGravity gravity;

@end


@implementation MToastUtil
...
+ (MToastUtil *)__createWithText:(NSString *)text {
    ...
    MToastUtil *toast = [[MToastUtil alloc] initWithFrame:frame];
...
+ (MToastUtil *)__createWithImage:(UIImage *)image {
    CGSize screenSize = [UIScreen mainScreen].bounds.size;
    CGFloat screenWidth = screenSize.width;
...
+ (void)showWithText:(NSString *)text {
    [MToastUtil showWithText:text gravity:kWTGravityBottom];
}
...
+ (void)showWithText:(NSString *)text gravity:(MToastUtilGravity)gravity {
    [MToastUtil showWithText:text duration:kWTShort roundedCorners:NO gravity:gravity];
}
...
+ (void)showWithImage:(UIImage *)image {
    [MToastUtil showWithImage:image gravity:kWTGravityBottom];
}
...
+ (void)showWithImage:(UIImage *)image gravity:(MToastUtilGravity)gravity {
    [MToastUtil showWithImage:image duration:kWTShort roundedCorners:NO gravity:gravity];
}
...
+ (void)showWithText:(NSString *)text duration:(NSInteger)duration {
    [MToastUtil showWithText:text duration:kWTShort gravity:kWTGravityBottom];
}
...
+ (void)showWithImage:(UIImage *)image duration:(NSInteger)duration {
    [MToastUtil showWithImage:image duration:kWTShort roundedCorners:NO gravity:kWTGravityBottom];
}
...
+ (void)showWithText:(NSString *)text duration:(NSInteger)duration roundedCorners:(BOOL)roundedCorners {
    [MToastUtil showWithText:text duration:duration roundedCorners:roundedCorners gravity:kWTGravityBottom];
}
...
+ (void)showWithText:(NSString *)text duration:(NSInteger)duration roundedCorners:(BOOL)roundedCorners gravity:(MToastUtilGravity)gravity {
    MToastUtil *toast = [MToastUtil __createWithText:text];
...
+ (void)showWithImage:(UIImage *)image duration:(NSInteger)duration roundedCorners:(BOOL)roundedCorners {
    [MToastUtil showWithImage:image duration:duration roundedCorners:roundedCorners gravity:kWTGravityBottom];
}
...
+ (void)showWithImage:(UIImage *)image duration:(NSInteger)duration roundedCorners:(BOOL)roundedCorners gravity:(MToastUtilGravity)gravity {
    MToastUtil *toast = [MToastUtil __createWithImage:image];
    toast.duration = duration;
    toast.roundedCorners = roundedCorners;
    toast.gravity = gravity;
